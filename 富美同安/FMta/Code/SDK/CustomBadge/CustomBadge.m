...
//	CGSize stringSize = [badgeString sizeWithAttributes: @{NSFontAttributeName: [UIFont fontWithName:@"Arial" size:12]}];
    
    CGSize stringSize;
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0)
    {
        stringSize = [badgeString sizeWithAttributes: @{NSFontAttributeName: [UIFont fontWithName:@"Arial" size:12]}];
    }
    else
    {
        stringSize = [badgeString sizeWithFont:[UIFont systemFontOfSize:12]
...
//		CGSize textSize = [self.badgeText sizeWithAttributes: @{NSFontAttributeName: [UIFont fontWithName:@"Arial" size:sizeOfFont]}];
        CGSize textSize;
        if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0)
        {
            textSize = [self.badgeText sizeWithAttributes: @{NSFontAttributeName: [UIFont fontWithName:@"Arial" size:sizeOfFont]}];
        }
        else
        {
            textSize = [self.badgeText sizeWithFont:[UIFont systemFontOfSize:sizeOfFont]
                                 constrainedToSize:CGSizeMake(CGFLOAT_MAX,30)
                                     lineBreakMode:NSLineBreakByWordWrapping];
        ...
        if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0)
        {
            [self.badgeText drawAtPoint:CGPointMake((rect.size.width/2-textSize.width/2), (rect.size.height/2-textSize.height/2)) withAttributes:@{NSFontAttributeName: [UIFont fontWithName:@"Arial" size:sizeOfFont]}];
        }
        else
            [self.badgeText drawAtPoint:CGPointMake((rect.size.width/2-textSize.width/2), (rect.size.height/2-textSize.height/2)) withFont:[UIFont fontWithName:@"Arial" size:sizeOfFont]];
	}
