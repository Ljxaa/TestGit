...
- (instancetype)init {
    if ((self = [super initWithFrame:CGRectMake(0, 0, Size, Size)])) {
        ...
        UILabel *lab=[[UILabel alloc]initWithFrame:CGRectMake(self.imageView.frame.origin.x, self.imageView.frame.size.height+10, self.imageView.frame.size.width, 20)];
        [lab setText:@"载入中，请稍等..."];
...
- (UIView *)overlay {
    ...
    if (!self.overlayView) {
        ...
        [self.overlayView setBackgroundColor:[UIColor colorWithRed:0 green:0 blue:0 alpha:0.3]];
