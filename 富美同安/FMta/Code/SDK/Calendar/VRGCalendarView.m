...
- (void)drawRect:(CGRect)rect
{
    ...
    labelCurrentMonth.frame = CGRectMake(50, 0, [[UIScreen mainScreen] bounds].size.width-100, 40);
    ...
    for (int i =0; i<[weekdays count]; i++) {
        ...
        [weekdayValue drawInRect:CGRectMake(i*(kVRGCalendarViewDayWidth+2), kVRGCalendarViewWeekHeight, kVRGCalendarViewDayWidth+2, 20) withFont:font lineBreakMode:NSLineBreakByWordWrapping alignment:YES];
    }
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        {
            if ([selectedDate year] == [todayDate year] && [selectedDate month] == [todayDate month] && [selectedDate day] == [todayDate day] )
            {
                CGRect rectangleGrid = CGRectMake(targetX,targetY,kVRGCalendarViewDayWidth+2,kVRGCalendarViewDayHeight+2);
                CGContextAddRect(context, rectangleGrid);
                CGContextSetFillColorWithColor(context, [UIColor colorWithHexString:@"0x383838"].CGColor); //0x006dbc
                CGContextFillPath(context);
        ...
        [date drawInRect:CGRectMake(targetX+2, targetY+FontHeight, kVRGCalendarViewDayWidth, kVRGCalendarViewDayHeight) withFont:[UIFont fontWithName:@"HelveticaNeue-Bold" size:FontSize] lineBreakMode:NSLineBreakByWordWrapping alignment:YES];
    }
    ...
    for (int i = 0; i<[self.markedDates count]; i++) {
        ...
        CGRect rectangleGrid = CGRectMake(targetX + 0.5,targetY + 0.5,kVRGCalendarViewDayWidth + 1, kVRGCalendarViewDayHeight + 1);
        CGContextAddRect(context, rectangleGrid);
...
-(id)init
{
    ...
    kVRGCalendarViewTopBarHeight = 60;
    kVRGCalendarViewWidth = [[UIScreen mainScreen] bounds].size.width;
    kVRGCalendarViewDayWidth = [[UIScreen mainScreen] bounds].size.width/7-2;
    kVRGCalendarViewDayHeight = [[UIScreen mainScreen] bounds].size.width/7-2;
    if ([[UIScreen mainScreen] bounds].size.height > 1024) {
        kVRGCalendarViewDayWidth = 107;
        kVRGCalendarViewDayHeight = 107;
        kVRGCalendarViewWeekHeight = 80;
        FontSize = 30.0;
        FontHeight = 20;
    }
    else
    {
        kVRGCalendarViewWeekHeight = 40;
        FontSize = 15.0;
        FontHeight = 10;
    }
    ...
    if (self) {
        ...
        labelCurrentMonth.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:FontSize];
