...
//#define kVRGCalendarViewWeekHeight 40
//#define FontSize 15.0
//#define FontHeight 10

//#define FontHeight 40
//#define FontSize 25.0
//#define kVRGCalendarViewWeekHeight 80
//#define kVRGCalendarViewTopBarHeight 144
//#define kVRGCalendarViewWidth 768
//
//#define kVRGCalendarViewDayWidth 106
//#define kVRGCalendarViewDayHeight 106
...
@interface VRGCalendarView : UIView {
    ...
    float FontHeight;
    float FontSize;
    float kVRGCalendarViewWeekHeight;
    float kVRGCalendarViewTopBarHeight;
    float kVRGCalendarViewWidth;
    float kVRGCalendarViewDayWidth;
    float kVRGCalendarViewDayHeight;
