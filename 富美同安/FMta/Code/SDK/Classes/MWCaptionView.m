...
//    UIToolbar *myToolBar = [[UIToolbar alloc] initWithFrame:CGRectIntegral(CGRectMake(labelPadding, -60,self.bounds.size.width-labelPadding*2,self.bounds.size.height))];
//    [self addSubview:myToolBar];
//    UITextView *feedBackMsg = [[UITextView alloc] initWithFrame:CGRectIntegral(CGRectMake(0, 0,self.bounds.size.width-labelPadding*2,self.bounds.size.height))] ;
...
//    if ([_photo respondsToSelector:@selector(caption)]) {
//        feedBackMsg.text = [_photo caption] ? [_photo caption] : @" ";
//    }
//    [myToolBar addSubview:feedBackMsg];
